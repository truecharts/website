...
In TrueCharts verwenden wir manchmal Code, der eine andere Lizenz hat als der Rest des Projekts. Wenn noch kein Lizenzheader vorhanden ist, verwenden wir diese Standardlizenz-Header.

## TPL

```go
{{/*
Unter der Apache-Lizenz, Version 2.0 lizenziert (die "Lizenz");
...
Diese Datei wird vom TrueCharts-Projekt als modifiziert angesehen.
*/}}
```
...
# Siehe die Lizenz für die bestimmte Sprache, die Berechtigungen regelt, und
