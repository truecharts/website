...
Technitium DNS 服务器是一个开放源代码权威以及递归的DNS服务器，可以用于为隐私 & 的安全自我托管DNS服务器。
...
* [https://techinitium.com/](https://technitium.com/)
* [https://hub.docker.com/r/technitisum/dns-server](https://hub.docker.com/r/technitium/dns-server)
