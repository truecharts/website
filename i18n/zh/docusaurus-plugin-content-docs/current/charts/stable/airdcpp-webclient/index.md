...
AirDC++ Web 客户端是本地安装的应用程序 它旨在在本地网络或互联网上灵活地共享文件或目录。
...
* [https://github.com/airdcpp-web/airdcpp-web客户端](https://github.com/airdcpp-web/airdcpp-webclient)
* [https://hub.docker.com/r/gangeffors/airdcpp-webclient](https://hub.docker.com/r/gangefors/airdcpp-webclient)
