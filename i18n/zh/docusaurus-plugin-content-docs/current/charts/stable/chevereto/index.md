...
Chevereto是一个图像托管软件，您可以在自己的服务器上创建一个美丽和全功能的图像托管网站。
...
* [https://hub.docker.com/r/linuxserver/cheverto](https://hub.docker.com/r/linuxserver/chevereto)
* [https://chevereto-free.github.io/setup/system/environment.html#image-handling-varies](https://chevereto-free.github.io/setup/system/environment.html#image-handling-variables)
