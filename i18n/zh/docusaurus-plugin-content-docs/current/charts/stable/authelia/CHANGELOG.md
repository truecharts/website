...
- 暂时禁用HTTP探测([#3173](https://github.com/truecharts/apps/issues/3173))
...
### [authelia-8.0.18](https://github.com/truecharts/apps/compare/authelia-8.0.17...authelia-8.0.18) (2021-12-18岁)
...
* 更新非主要背包头盔版本([#1247](https://github.com/truecharts/apps/issues/1247))
