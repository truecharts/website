...
音频书架是一个自行托管的音频簿服务器，用于管理和播放您的音频簿。
...
* [https://hub.docker.com/r/advplyr/audiobookassump](https://hub.docker.com/r/advplyr/audiobookshelf)
* [https://github.com/advplyr/audiobookshell](https://github.com/advplyr/audiobookshelf)
