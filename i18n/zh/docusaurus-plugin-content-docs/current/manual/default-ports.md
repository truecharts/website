...
| 应用            |       服务       |      端口名称      |  端口   | Protocol | 状态  | 说明                                           |
|:------------- |:--------------:|:--------------:|:-----:|:--------:|:---:|:-------------------------------------------- |
| Adguard-home  |    dns-tcp     |    dns-tcp     |  53   |   TCP    | 已启用 | Potential conflict with: pihole technitium   |
| Adguard-home  |    dns-udp     |    dns-udp     |  53   |   UDP    | 已启用 | -                                            |
| technitium    |    dns-tcp     |    dns-tcp     |  53   |   TCP    | 已启用 | Potential conflict with: pihole adguard-home |
