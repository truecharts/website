...
Once you have completed the above, you are finished the migration process and are back to business as usual. Your apps datasets should now look something like this:
...
1. Try to delete the dataset

2. If this fails, note the name of the failed app(s) and continue migrating all others

3. Once you've completed migrated the rest of your apps, [unset](https://www.truenas.com/docs/scale/scaleuireference/apps/#unset-pool) your apps pool

4. Try deleting all failed app datasets

5. [Re-set](https://www.truenas.com/docs/scale/scaleuireference/apps/#settings) your apps pool

6. Re-run the migration script with --skip appended for all failed apps
