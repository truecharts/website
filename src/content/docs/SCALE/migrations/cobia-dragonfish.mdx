...
4. Migrate Apps to New Storage using TT-Migration Script
    ...
    - Apps without PVC storage do need to be reinstalled to remove every remnant of old storage backends. You will see a notice in the script if you attempt to migrate an app with no PVCs.
