...
4. Migrate Apps to New Storage using TT-Migration Script
    ...
    **NEVER** attempt to delete or reinstall system train apps without direction from the support team. Doing so will result in data loss.
