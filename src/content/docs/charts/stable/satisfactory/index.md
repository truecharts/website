...
![Version: 11.2.2](https://img.shields.io/badge/Version-11.2.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.7.4](https://img.shields.io/badge/AppVersion-1.7.4-informational?style=flat-square)
...
`helm install mychart oci://tccr.io/truecharts/satisfactory`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/satisfactory/values.yaml
