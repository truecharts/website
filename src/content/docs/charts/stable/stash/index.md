...
![Version: 17.2.5](https://img.shields.io/badge/Version-17.2.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.26.2](https://img.shields.io/badge/AppVersion-0.26.2-informational?style=flat-square)
...
`helm install mychart oci://tccr.io/truecharts/stash`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/stash/values.yaml
