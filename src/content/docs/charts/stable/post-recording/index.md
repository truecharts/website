...
`helm install mychart oci://tccr.io/truecharts/post-recording`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/post-recording/values.yaml
