...
![Version: 7.2.0](https://img.shields.io/badge/Version-7.2.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1380.0.0](https://img.shields.io/badge/AppVersion-1380.0.0-informational?style=flat-square)
...
`helm install mychart oci://tccr.io/truecharts/remotely`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/remotely/values.yaml
