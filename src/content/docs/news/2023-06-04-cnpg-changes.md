...
- export all your databases manually, on SCALE using the [following guide](/scale/guides/cnpg-migration-guide) (do **not** rely on heavyscript backups for this!)
...
- wait a few minutes
- Restore all your databases manually, on SCALE using the [following guide](/scale/guides/cnpg-migration-guide) (do **not** rely on heavyscript backups for this!)
