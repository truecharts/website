...
We heavily advice using a more mature and solid kubernetes platform such as "TalosOS" isntead
...
If you are migrating from a different CNPG operator, you can use our [CNPG Migration Guide](/development/scale/cnpg-migration-guide) for steps on how to install the `Cloudnative-PG` operator and migrating to it. We also have [this](/general/faq#operators) FAQ entry on removing the previous CNPG backend once migrated.
