...
It supports more forms of certificates, is faster to setup and is build by people that are *actually* specialised in certificate management. Which, lets be realistic, NAS developers are not.
