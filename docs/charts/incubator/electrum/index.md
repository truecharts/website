...
For more information, please click here: [electrum](https://truecharts.org/docs/charts/incubator/electrum)
...
To install the chart with the release name `electrum`

```console
helm repo add TrueCharts https://charts.truecharts.org
helm repo update
helm install electrum TrueCharts/electrum
```
...
To uninstall the `electrum` deployment

```console
helm uninstall electrum
```
...
```console
helm install electrum TrueCharts/electrum -f values.yaml
```
