...
For more information, please click here: [godaddy-ddns](https://truecharts.org/docs/charts/incubator/godaddy-ddns)
...
To install the chart with the release name `godaddy-ddns`

```console
helm repo add TrueCharts https://charts.truecharts.org
helm repo update
helm install godaddy-ddns TrueCharts/godaddy-ddns
```
...
To uninstall the `godaddy-ddns` deployment

```console
helm uninstall godaddy-ddns
```
...
```console
helm install godaddy-ddns \
  --set env.TZ="America/New York" \
    TrueCharts/godaddy-ddns
```
...
```console
helm install godaddy-ddns TrueCharts/godaddy-ddns -f values.yaml
```
