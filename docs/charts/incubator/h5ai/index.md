...
For more information, please click here: [h5ai](https://truecharts.org/docs/charts/incubator/h5ai)
...
To install the chart with the release name `h5ai`
...
To uninstall the `h5ai` deployment
...
```console
helm install h5ai TrueCharts/h5ai -f values.yaml
```
