...
For more information, please click here: [openttd](https://truecharts.org/docs/charts/incubator/openttd)
...
To install the chart with the release name `openttd`

```console
helm repo add TrueCharts https://charts.truecharts.org
helm repo update
helm install openttd TrueCharts/openttd
```
...
To uninstall the `openttd` deployment

```console
helm uninstall openttd
```
...
```console
helm install openttd TrueCharts/openttd -f values.yaml
```
