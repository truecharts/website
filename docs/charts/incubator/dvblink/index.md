...
For more information, please click here: [dvblink](https://truecharts.org/docs/charts/incubator/dvblink)
...
To install the chart with the release name `dvblink`

```console
helm repo add TrueCharts https://charts.truecharts.org
helm repo update
helm install dvblink TrueCharts/dvblink
```
...
To uninstall the `dvblink` deployment

```console
helm uninstall dvblink
```
...
```console
helm install dvblink TrueCharts/dvblink -f values.yaml
```
