...
For more information, please click here: [import-ics](https://truecharts.org/docs/charts/incubator/import-ics)
...
To install the chart with the release name `import-ics`
...
To uninstall the `import-ics` deployment

```console
helm uninstall import-ics
```
...
```console
helm install import-ics TrueCharts/import-ics -f values.yaml
```
