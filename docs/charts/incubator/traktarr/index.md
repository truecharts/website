...
For more information, please click here: [traktarr](https://truecharts.org/docs/charts/incubator/traktarr)
...
To install the chart with the release name `traktarr`
...
To uninstall the `traktarr` deployment

```console
helm uninstall traktarr
```
...
```console
helm install traktarr TrueCharts/traktarr -f values.yaml
```
