...
For more information, please click here: [mango](https://truecharts.org/docs/charts/incubator/mango)
...
To install the chart with the release name `mango`

```console
helm repo add TrueCharts https://charts.truecharts.org
helm repo update
helm install mango TrueCharts/mango
```
...
To uninstall the `mango` deployment

```console
helm uninstall mango
```
...
```console
helm install mango TrueCharts/mango -f values.yaml
```
