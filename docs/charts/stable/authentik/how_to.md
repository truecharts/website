...
This guide assumes you're using Traefik as your Reverse Proxy / Ingress provider and have through the configuration listed in our Traefik [guide](../../premium/traefik/index.md) and/or the [Traefik documents](../../premium/traefik/how-to.md). Please ensure that you can access your domain properly with Ingress before attempting any further steps. 
