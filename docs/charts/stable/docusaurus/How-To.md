...
Recommended for use with a domain name but not required as mentioned above. You can refer to our [Quick-Start Guides](../../../manual/SCALE/options/ingress.md) for an overview on using Ingress with your chart.
