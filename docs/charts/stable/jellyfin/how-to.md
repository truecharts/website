...
- Installation of the TrueCharts Catalog, starting [here](../../../manual/SCALE/guides/getting-started.md#adding-truecharts)
...
- We recommend having configured your media before installing the chart.
  ...
  and for that you can simply follow our [Adding Storage](../../../manual/SCALE/guides/add-storage.md)
...
- However some will prefer `NFS Shares` for this storage,
  ...
  devices outside of TrueNAS, so we recommend following the [using NFS Shares guide](../../../manual/SCALE/guides/nfs-share.md).
